...
static NSString* const XhlWKCookiesKey = @"org.skyfox.XhlWKShareInstanceCookies";

@implementation WKWebView (XhlWebCookie)
...
- (void)insertCookie:(NSHTTPCookie *)cookie
{
    @autoreleasepool {
        ...
        NSMutableArray *localCookies =[NSKeyedUnarchiver unarchiveObjectWithData: [[NSUserDefaults standardUserDefaults] objectForKey: XhlWKCookiesKey]];
        ...
        [[NSUserDefaults standardUserDefaults] setObject:cookiesData forKey:XhlWKCookiesKey];
...
- (NSMutableArray *)sharedHTTPCookieStorage
{
    @autoreleasepool {
        ...
        /** 获取自定义存储的cookies */
        NSMutableArray *cookies = [NSKeyedUnarchiver unarchiveObjectWithData: [[NSUserDefaults standardUserDefaults] objectForKey: XhlWKCookiesKey]];
